...
import com.zhenaixuanyan.app.videos.Adapter.MyVideoListAdapter;
...
public class MyVideoListActivity extends BaseActivity {
    ...
    void afterViews(){
        ...
        MyVideoListAdapter adapter = new MyVideoListAdapter();
        adapter.setList(mDatas);
        mRecyclerView.setAdapter(adapter);
        mSwipeRefreshWidget.setRefreshing(false);
        adapter.setOnItemClickLitener(new MyVideoListAdapter.OnItemClickLitener() {
            @Override
